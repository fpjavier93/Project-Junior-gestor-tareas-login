...
import { createTask, getUserID } from "../services/CreateTaskServices";
...
function CreateTaskPage() {
  ...
  async function handleSubmit(e) {
    ...
    const dataTask = Object.fromEntries(
  ...
  return (
    <div className="max-w-4xl px-4 mx-auto">
      <header className="flex justify-between py-10">
        <div>
          ...
          <h2 className="text-gray-500">
            Crea una tarea y define su contenido
          </h2>
        </div>
      ...
      <div className="flex justify-end">
        <Inicio onclick={() => navigate("/Dashboard")} />
      </div>
          ...
          <div>
            ...
            <div className="py-5">
              ...
              <div className="flex justify-end gap-3">
                <White name="Cancelar" onClick={() => navigate("/dashboard")} />
